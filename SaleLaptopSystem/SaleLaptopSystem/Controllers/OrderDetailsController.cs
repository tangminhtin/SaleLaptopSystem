...
namespace SaleLaptopSystem.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Quantity,Price,OrderID,ProductID")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Quantity,Price,OrderID,ProductID")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
